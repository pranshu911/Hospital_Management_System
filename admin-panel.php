        ...
        <div class="row">
            <div class="col-md-4" style="max-width:25%; margin-top: 3%">
                <div class="list-group" id="list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-ai-help" id="list-ai-help-list"
                        data-toggle="list" role="tab" aria-controls="home">AI Help</a>
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  ?>
                    ...
                    <div class="tab-pane fade" id="list-ai-help" role="tabpanel" aria-labelledby="list-ai-help-list">
                        <p>Artificial Intelligence (AI) is revolutionizing the way we live and work. </p>
                        <div class=" py-5 w-100">
                            <div class="w-100 justify-content-center">
                                <div class=" w-100">
                                    <div class="chat-box  rounded">
                                        <div class="p-3 bg-primary text-white">
                                            <h4 class="m-0">Chat with Us!</h4>
                                        </div>
                                        ...
                                        <div class="container  flex justify-center text-xs">
                                            <div class="spinner-border custom-blue text-blue spinner-border-sm  justify-content-center"
                                                role="status" style="display:none;" id="loadingSpinner"><span
